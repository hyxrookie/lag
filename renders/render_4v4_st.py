...
enm_policy_index = 20
episode_rewards = 0
ego_run_dir = "/mnt/c/Users/hyx/PycharmProjects/lag0108/scripts/results/MultipleCombat/4v4/ShootMissile/HierarchySelfplay/st/v1/run41/"
enm_run_dir = "/mnt/c/Users/hyx/PycharmProjects/lag0108/scripts/results/MultipleCombat/4v4/ShootMissile/HierarchySelfplay/st/v1/run41/"
experiment_name = ego_run_dir.split('/')[-4]
env = MultipleCombatEnv(scenario_name)
env.seed(0)
args = Args()

ego_policy = PPOActorST(args, env.observation_space, env.action_space, device=torch.device("cuda"))
enm_policy = PPOActorST(args, env.observation_space, env.action_space, device=torch.device("cuda"))
ego_policy.eval()
enm_policy.eval()
...
ego_rnn_states = np.zeros((1, 1, 8192), dtype=np.float32)

import torch
from .ppo_actor import PPOActorMLPT
from .ppo_critic import PPOCriticMLPT
...
class PPOPolicy:
    def __init__(self, args, obs_space, cent_obs_space, act_space, device=torch.device("cpu")):
        ...
        self.actor = PPOActorMLPT(args, self.obs_space, self.act_space, self.device)
        self.critic = PPOCriticMLPT(args, self.cent_obs_space, self.device)

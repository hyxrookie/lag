...
from ..utils.spatial_temporal_base_MLP_T import SpatialTemporalBaseMLPT
from ..utils.spatial_temporal_base_gru import SpatialTemporalBaseGRU
from ..utils.utils import check


class PPOCriticMLPT(nn.Module):
    def __init__(self, args, obs_space, device=torch.device("cpu")):
        super(PPOCriticMLPT, self).__init__()
        # network config
        ...
        self.base = SpatialTemporalBaseMLPT(

import torch
from .ppo_actor import PPOActorSGRU
from .ppo_critic import PPOCriticSGRU
...
class PPOPolicy:
    def __init__(self, args, obs_space, cent_obs_space, act_space, device=torch.device("cpu")):
        ...
        self.actor = PPOActorSGRU(args, self.obs_space, self.act_space, self.device)
        self.critic = PPOCriticSGRU(args, self.cent_obs_space, self.device)

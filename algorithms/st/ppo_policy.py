import torch
from .ppo_actor import PPOActorST
from .ppo_critic import PPOCriticST
...
class PPOPolicy:
    def __init__(self, args, obs_space, cent_obs_space, act_space, device=torch.device("cpu")):
        ...
        self.actor = PPOActorST(args, self.obs_space, self.act_space, self.device)
        self.critic = PPOCriticST(args, self.cent_obs_space, self.device)
